...
<html>
  <head>
    ...
    <title>Ansible Ecosystem</title>
    <meta name="description" content="Ansible Ecosystem Documentation" />
  ...
  <style>
    ...
    html {
      color: #333;
      font-weight: 300;
      font-family: RedHatText, "Red Hat Text", Overpass, "Helvetica Neue", Arial,
        sans-serif;
    }
    ...
    h5,
    h6 {
      font-family: RedHatDisplay, "Red Hat Display", Overpass, "Helvetica Neue",
        Arial, sans-serif;
    }
        ...
        <div class="collapse navbar-collapse" id="main-menu">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a
                class="nav-link"
                href="https://www.ansible.com/products/automation-platform"
                >Products</a
              >
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="https://www.ansible.com/community"
                >Community</a
              >
            </li>
            <li class="nav-item">
        ...
        <div class="row justify-content-center">
          <div class="col text-center">
            <svg
              ...
              style="overflow: visible; enable-background: new 0 0 98.5 98.5"
              xml:space="preserve"
              class="mb-3"
            >
              <style type="text/css">
              ...
              <defs></defs>
              <g
                id="Ansible-Mark-RGB_Pool_1_"
                transform="translate(-46.207 -46.127)"
              >
                <path
                  id="Path_13_1_"
                  class="ansLogo_st0"
                  d="M144.7,95.4c0,27.2-22,49.2-49.2,49.2s-49.2-22-49.2-49.2s22-49.2,49.2-49.2l0,0
                    C122.6,46.1,144.7,68.2,144.7,95.4"
                />
                <path
                  id="Path_14_1_"
                  class="ansLogo_st1"
                  d="M96.3,76.9l12.7,31.4L89.8,93.2L96.3,76.9z M118.9,115.6L99.3,68.4c-0.5-1.3-1.7-2.1-3-2.1
                    c-1.4,0-2.6,0.8-3.1,2.1l-21.5,51.7H79l8.5-21.3l25.4,20.5c0.7,0.7,1.7,1.2,2.7,1.2c1.9,0,3.6-1.5,3.6-3.4c0,0,0-0.1,0-0.1
                    C119.2,116.5,119.1,116.1,118.9,115.6"
                />
              </g>
            </svg>

            <h1 class="mb-2">Ansible Ecosystem</h1>
            <p class="subhead">
    ...
    <section class="cards pt-0">
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <a href="core.html">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Ansible Core</h4>
                  <p class="card-text">
                    Ansible Core is the language and runtime that powers
                    automation.
                  </p>
                </div>
                <div class="card-footer">
                  <a href="core.html" class="btn btn-outline-black"
                    >Learn more</a
                  >
                </div>
              </div>
            ...
            <a href="https://ansible-navigator.readthedocs.io/">
              <div class="card border">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Ansible Navigator is a command-line tool for creating, reviewing,
                    and troubleshooting Ansible content.
                  </p>
                </div>
                <div class="card-footer">
                  <a
          ...
          <div class="col-md-6 col-lg-4">
            <a href="https://molecule.readthedocs.io/">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Molecule</h4>
                  <p class="card-text">
                ...
                <div class="card-footer">
                  <a
                    href="https://molecule.readthedocs.io/"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <a href="https://ansible-lint.readthedocs.io/">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Ansible Lint</h4>
                  <p class="card-text">
                    Lint improves code quality through proven best practices,
                    patterns, and behaviors so that your Ansible content results
                    in reliable and consistent automation.
                  </p>
                </div>
                <div class="card-footer">
                  <a
          ...
          <div class="col-md-6 col-lg-4">
            ...
            >
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Ansible VS Code Extension</h4>
                  <p class="card-text">
                    The VS Code extention adds Ansible language support to
                    Visual Studio Code and OpenVSX compatible editors.
                  </p>
                </div>
                <div class="card-footer">
                  <a
          ...
          <div class="col-md-6 col-lg-4">
            <a href="https://als.readthedocs.io/">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Ansible Language Server</h4>
                  <p class="card-text">
                    Ansible Language Server implements language server protocol
                    (LSP) to highlight and check Ansible syntax.
                  </p>
                </div>
                <div class="card-footer">
                  <a
                    href="https://als.readthedocs.io/"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <a href="https://ansible-sdk.readthedocs.io/en/latest/">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Ansible SDK</h4>
                  <p class="card-text">
                    Ansible SDK is a toolkit that lets you harness the power and
                    simplicity of Ansible automation directly from your
                    applications.
                  </p>
                </div>
                <div class="card-footer">
                  <a
                    href="https://ansible-sdk.readthedocs.io/en/latest/"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="https://ansible-runner.readthedocs.io/en/stable/">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Ansible Runner</h4>
                  <p class="card-text">
                    Ansible Runner provides a stable and consistent interface
                    abstraction to Ansible.
                  </p>
                </div>
                <div class="card-footer">
                  <a
                    href="https://ansible-runner.readthedocs.io/en/stable/"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="https://ansible-builder.readthedocs.io/en/latest/">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Ansible Builder</h4>
                  <p class="card-text">
                    Ansible Builder lets you create Execution Environments, which are container
                    images that act as Ansible control nodes.
                  </p>
                </div>
                <div class="card-footer">
                  <a
                    href="https://ansible-builder.readthedocs.io/en/latest/"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <a href="https://receptor.readthedocs.io/en/latest/index.html">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Receptor</h4>
                  <p class="card-text">
                    Receptor is an overlay network that distributes workloads
                    across a large and dispersed collection of nodes.
                  </p>
                </div>
                <div class="card-footer">
                  <a
                    href="https://receptor.readthedocs.io/en/latest/index.html"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="https://github.com/ansible/eda-server">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Event-Driven Ansible Server</h4>
                  <p class="card-text">
                    Event-Driven Ansible Server offers scalable and flexible automation that
                    can subscribe to a wide variety of event sources.
                  </p>
                </div>
                <div class="card-footer">
                  <a
                    href="https://github.com/ansible/eda-server"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="https://ansible-rulebook.readthedocs.io/en/latest/">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Ansible Rulebook</h4>
                  <p class="card-text">
                    Ansible Rulebook is a command-line tool that listens to events so
                    your automation can react when software or system states change.
                  </p>
                </div>
                <div class="card-footer">
                  <a
                    href="https://ansible-rulebook.readthedocs.io/en/latest/"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <a href="https://galaxy.ansible.com/docs/">
              <div class="card border">
                <div class="card-body">
          ...
          <div class="col-md-6 col-lg-4">
            <a href="https://galaxyng.netlify.app/">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Galaxy NG</h4>
                  <p class="card-text">
                ...
                <div class="card-footer">
                  <a
                    href="https://galaxyng.netlify.app/"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="https://ansible.github.io/ansible-sign/">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Ansible Sign</h4>
                  <p class="card-text">
                ...
                <div class="card-footer">
                  <a
                    href="https://ansible.github.io/ansible-sign/"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <a href="https://ansible-compat.readthedocs.io/">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Ansible Compat</h4>
                  <p class="card-text">
                    Compat is a Python package that assists with compatibility
                    between different Ansible releases, starting at version 2.9.
                  </p>
                </div>
                <div class="card-footer">
                  <a
                    href="https://ansible-compat.readthedocs.io/"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="https://ansible-pylibssh.readthedocs.io/en/latest/">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Ansible Pylibssh</h4>
                  <p class="card-text">
                ...
                <div class="card-footer">
                  <a
                    href="https://ansible-pylibssh.readthedocs.io/en/latest/"
                    class="btn btn-outline-black"
                    >Visit the documentation</a
                  >
                </div>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="https://github.com/ansible/pinakes">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Pinakes</h4>
                  <p class="card-text">
                    Pinakes lets you make Ansible job templates and workflows available to business users
                    with an added layer of governance.
                  </p>
                </div>
                <div class="card-footer">
                  <a
                    href="https://github.com/ansible/pinakes"
                    class="btn btn-outline-black"
                    >Go to GitHub</a
                  >
                </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4">
            <a href="https://github.com/ansible/awx-operator">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">AWX Operator</h4>
                  <p class="card-text">
                    Ansible AWX Operator offers built-in intelligence and operational
                    best practices for deploying on Kubernetes environments.
                  </p>
                </div>
                <div class="card-footer">
                  <a
                    href="https://github.com/ansible/awx-operator"
                    class="btn btn-outline-black"
                    >Go to GitHub</a
                  >
                </div>
      ...
      !(function (a) {
        ...
        function l(a) {
            ...
            function b() {
              function a() {
                ...
                for (
                  h(
                    V,
                    "Checking connection is from allowed list of origins: " + d
                  );
                  a < d.length;
                  a++
                )
          ...
          function F(a) {
            ...
            function d() {
              window.parentIFrame
                ? window.parentIFrame["scrollTo" + (a ? "Offset" : "")](
                    f.x,
                    f.y
                  )
                : j(
        ...
        function m(a, b, c) {
          ...
          if (P[a]) {
            if (((d = P[a][b]), "function" != typeof d))
              throw new TypeError(
                b + " on iFrame[" + a + "] is not a function"
              );
            e = d(c);
          }
          return e;
        ...
        function s(a) {
          ...
          var e = a.iframe.id;
          P[e] &&
            (P[e].sizeHeight && d("height"), P[e].sizeWidth && d("width"));
        }
        function t(a, b, c) {
          c !== b.type && N
            ? (h(b.id, "Requesting animation frame"), N(a))
            : a();
        }
        ...
        function w(c, d) {
          ...
          function q(a) {
            for (var b in S)
              S.hasOwnProperty(b) &&
                (P[x][b] = a.hasOwnProperty(b) ? a[b] : S[b]);
          }
          function s(a) {
            return "" === a || "file://" === a ? "*" : a;
          }
