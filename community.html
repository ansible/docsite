...
<head>
    ...
    <title>Ansible Community Documentation</title>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col text-center">
                    ...
                    <p class="subhead">Join our community of contributors for Ansible.</p>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
              <div class="col-md-6 col-lg-4">
                  <a href="https://docs.ansible.com/ansible/latest/community/index.html">
                      <div class="card border">
                          <div class="card-body">
                              <h4 class="card-title">Community Documentation</h4>
                              <p class="card-text">Learn how to be a contributing member of the Ansible community.</p>
                          </div>
                          <div class="card-footer">
                              <a href="https://docs.ansible.com/ansible/latest/community/index.html" class="btn btn-outline-black">Learn more</a>
                          </div>
                      </div>
                  </a>
              </div>
              <div class="col-md-6 col-lg-4">
                  <a href="http://docs.ansible.com/ansible/latest/dev_guide/index.html">
                      <div class="card border">
                          <div class="card-body">
                              <h4 class="card-title">Developer Guide</h4>
                              <p class="card-text">Detailed information for developers on how to test and document collections and more.</p>
                          </div>
                          <div class="card-footer">
                              <a href="http://docs.ansible.com/ansible/latest/dev_guide/index.html" class="btn btn-outline-black">Learn more</a>
                          </div>
                      </div>
                  </a>
              </div>
