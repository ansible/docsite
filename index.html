...
<html>
  ...
  <style>
    /* Promo Section: change "display: block" to "display: none" to hide */
    .promo-banner {
      display: none;
    }
    ...
    .cards .header {
      background: url("assets/img/bg_dots.png") center center #d0d0d0;
  ...
  <body>
    <!-- BEGIN PROMOTIONAL BANNER - SEE '.promo-banner' CSS RULE TO TOGGLE OFF -->
    <section class="promo-banner py-0">
      <div
        class="container-fluid position-relative"
        style="z-index: 1000; background-color: #102441"
      >
        <div class="row justify-content-between align-items-center">
          <div class="col-auto d-none d-md-block px-0">
            <img
              ...
              alt="pattern"
              src="https://www.redhat.com/cms/managed-files/Docs_Banner_SVG_Left_small.svg"
              width="152"
            />
          </div>
          <div class="col">
            <div class="row justify-content-center align-items-center">
              <div
                class="col col-sm-auto col-md text-lg-right pl-sm-0 pr-0 py-1"
              >
                <img
                  src="https://www.redhat.com/cms/managed-files/rh-ansiblefest-2021-logo-pool-reverse-rgb_0.svg"
                  alt="AnsibleFest logo"
                  class="img-fluid"
                  width="145"
                />
              </div>
              <div
                class="col col-xl-auto text-center d-none d-lg-block px-lg-3"
              >
                <p class="font-size-16 mb-0 text-white">
                  Immerse yourself in the automation experience October 18-19 in
                  Chicago.
                </p>
              </div>
              <div class="col d-none d-lg-block px-0">
                <pfe-cta class="PFElement">
                  <a
                    href="https://www.ansible.com/ansiblefest?intcmp=7013a000002tuDxAAI"
              ...
              <div class="col col-sm-auto d-lg-none">
                <p class="font-size-16 my-1">
                  <a
                    href="https://www.ansible.com/ansiblefest?intcmp=7013a000002tuDxAAI"
                    class="ansiblefest-banner-cta text-white"
                    ><u
                      >Immerse yourself in the automation experience October
                      18-19 in Chicago.</u
                    ></a
                  >
                </p>
          ...
          <div class="col-auto d-none d-md-block px-0">
            <img
              class="d-none d-md-block"
              alt="pattern"
              src="https://www.redhat.com/cms/managed-files/Docs_Banner_SVG_Right_small.svg"
              width="152"
            />
          </div>
        </div>
    ...
    <!-- BEGIN PAGE TITLE -->
    <header class="headline py-8">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col col-lg-9 col-xl-8 text-center">
            <h1 class="mb-2">Ansible Documentation</h1>
            <p class="subhead">
              Welcome to the Ansible documentation.
              Find help that starts from the basic fundamentals of IT automation
              through to more advanced, enterprise-level use cases.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 d-flex">
            <div class="card border">
              <a href="ansible_community.html">
                <div class="header d-flex justify-content-center card-img-top">
                  <img
                    src="assets/img/icon_core.svg"
              ...
              <div class="card-body">
                <a href="ansible_community.html">
                  <h4 class="card-title">Ansible Community</h4>
                </a>
                <p class="card-text">
                  Our community documentation offers complete details for using Ansible
                  and Ansible collections.
                </p>
              </div>
              <div class="card-footer">
                <a href="ansible_community.html" class="btn btn-outline-black"
                  >Learn more</a
                >
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4 d-flex">
            <div class="card border">
              ...
              <div class="card-body">
                <a href="ecosystem.html">
                  <h4 class="card-title">Ansible Ecosystem</h4>
                </a>
                <p class="card-text">
                  Ansible is an ecosystem of projects that enable automation
                  capabilities for a wide range of use cases.
                </p>
              </div>
              <div class="card-footer">
                <a href="ecosystem.html" class="btn btn-outline-black"
                  >Learn more</a
                >
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4 d-flex">
            <div class="card border">
              <a href="collections.html">
                <div
                  class="header d-flex justify-content-center align-items-end card-img-top"
                >
                  <img
                    src="assets/img/icon_collections.svg"
                    class="img-fluid align-self-end"
                  />
                </div>
              </a>
              <div class="card-body">
                <a href="collections.html">
                  <h4 class="card-title">Ansible Collections</h4>
                </a>
                <p class="card-text">
                    Ansible collections extend the benefits of simple, powerful,
                    agentless automation.
                </p>
              </div>
              <div class="card-footer">
                <a href="collections.html" class="btn btn-outline-black"
                  >Learn more</a
                >
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4 d-flex">
            <div class="card border">
              <a href="automation.html">
                <div class="header d-flex justify-content-center card-img-top">
                  <img
                    src="assets/img/icon_automation.svg"
                    class="img-fluid align-self-end"
                  />
                </div>
              </a>
              <div class="card-body">
                <a href="automation.html">
                  <h4 class="card-title">Ansible Automation Platform</h4>
                </a>
                <p class="card-text">
                  Ansible Automation Platform centralizes automation infrastructure,
                  adds enterprise-grade capabilities, and provides supported collections.
                </p>
              </div>
              <div class="card-footer">
                <a href="automation.html" class="btn btn-outline-black"
                  >Learn more</a
                >
              </div>
            </div>
