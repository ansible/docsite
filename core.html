...
<head>
    ...
    <title>Ansible Core Documentation</title>
    <meta name="description" content="Ansible Core Documentation">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col text-center">
                    ...
                    <h1 class="mb-2">Ansible Core Documentation</h1>
                    <p class="subhead">Access to the ansible-core documentation</p>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-lg-4">
              ...
              <a href="https://docs.ansible.com/ansible-core/devel/index.html">
                <div class="card border">
                  <div class="card-body">
                    <h4 class="card-title">Ansible Core Documentation</h4>
                    <p class="card-text">
                      Ansible Core is the language and runtime that powers Ansible
                      automation. You can use Ansible Core directly or customize
                      and extend it with collections.
                    </p>
                  </div>
                  <div class="card-footer">
                    <a
                      href="https://docs.ansible.com/ansible-core/devel/index.html"
            ...
            <div class="col-md-6 col-lg-4">
              <a href="https://docs.ansible.com/ansible-core/devel/dev_guide/testing_running_locally.html">
                <div class="card border">
                  <div class="card-body">
                    <h4 class="card-title">Ansible Test</h4>
                    <p class="card-text">
                      Ansible Test is a command-line tool for performing sanity,
                      unit, and integration testing with Ansible Core and
                      collections.
                    </p>
                  </div>
                  <div class="card-footer">
                    <a
                      href="https://docs.ansible.com/ansible-core/devel/dev_guide/testing_running_locally.html"
                      class="btn btn-outline-black"
                      >Visit the documentation</a
                    >
                  </div>
            ...
            <div class="col-md-6 col-lg-4">
              <a href="core-translated-ja.html">
                <div class="card border">
                  <div class="card-body">
                    <h4 class="card-title">
                      日本語ドキュメント - Japanese Translations
                    </h4>
                    <p class="card-text">
                      For those who need translations of the documentation.
                    </p>
                  </div>
                  <div class="card-footer">
                    <a
