...
<head>
    ...
    <title>Ansible Core Documentation - Japanese translations- 日本語ドキュメント</title>
    <meta name="description" content="Ansible Core Documentation - Japanese translations">
...
<body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col text-center">
                    ...
                    height="98.5px" viewBox="0 0 98.5 98.5" style="overflow:visible;enable-background:new 0 0 98.5 98.5;" xml:space="preserve" class="mb-3">
                    <style type="text/css">
                    .ansLogo_st0{fill:#5BBDBF;}
                    .ansLogo_st1{fill:#FFFFFF;}
                    </style>
                    <defs>
                    </defs>
                    <g id="Ansible-Mark-RGB_Pool_1_" transform="translate(-46.207 -46.127)">
                    <path id="Path_13_1_" class="ansLogo_st0" d="M144.7,95.4c0,27.2-22,49.2-49.2,49.2s-49.2-22-49.2-49.2s22-49.2,49.2-49.2l0,0
                    C122.6,46.1,144.7,68.2,144.7,95.4"/>
                    <path id="Path_14_1_" class="ansLogo_st1" d="M96.3,76.9l12.7,31.4L89.8,93.2L96.3,76.9z M118.9,115.6L99.3,68.4c-0.5-1.3-1.7-2.1-3-2.1
                    ...
                    <h1 class="mb-2">日本語ドキュメント - Japanese Translations</h1>
                    <p class="subhead">Access to the Japanese translated core documentation</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <!-- BEGIN MAIN CARDS - Always put most recent version first -->
    <section class="cards pt-0">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-4">
                  <a href="https://docs.ansible.com/ansible-core/2.14_ja/index.html">
                     <div class="card border">
                         <div class="card-body">
                                <h4 class="card-title">ansible-core ドキュメント 2.14</h4>
                                <p class="card-text"></p>
                            </div>
                            <div class="card-footer">
                             <a href="https://docs.ansible.com/ansible-core/2.14_ja/index.html" class="btn btn-outline-black">Learn more</a>
                         </div>
                      </div>
                    </a>
                </div>
                <div class="col-md-6 col-lg-4">
                    <a href="https://docs.ansible.com/ansible-core/2.13_ja/index.html">
                       <div class="card border">
                           <div class="card-body">
                                  <h4 class="card-title">ansible-core ドキュメント 2.13</h4>
                                  <p class="card-text"></p>
                              </div>
                              <div class="card-footer">
                               <a href="https://docs.ansible.com/ansible-core/2.13_ja/index.html" class="btn btn-outline-black">Learn more</a>
                           </div>
                        </div>
                      </a>
                  </div>
           ...
           <div class="row">
                <div class="col-md-6 col-lg-4">
                    <a href="https://docs.ansible.com/ansible-core/2.12_ja/index.html">
                        <div class="card border">
                            <div class="card-body">
                                <h4 class="card-title">ansible-core ドキュメント 2.12</h4>
                                <p class="card-text"></p>
                            </div>
                            <div class="card-footer">
                                <a href="https://docs.ansible.com/ansible-core/2.12_ja/index.html" class="btn btn-outline-black">Learn more</a>
                            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="https://docs.ansible.com/ansible/2.9_ja/index.html">
                        <div class="card border">
                            <div class="card-body">
                                <h4 class="card-title">Ansible ドキュメント 2.9</h4>
                                <p class="card-text"></p>
                            </div>
                            <div class="card-footer">
                                <a href="https://docs.ansible.com/ansible/2.9_ja/index.html" class="btn btn-outline-black">Learn more</a>
                            </div>
