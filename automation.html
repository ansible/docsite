...
<html>
  <head>
    ...
    <title>Red Hat Ansible Automation Controller Docs</title>
    <meta
      name="description"
      content="Red Hat Ansible Automation Controller Docs"
    />
        ...
        <div class="row justify-content-center">
          <div class="col text-center">
            <img
              ...
              class="mb-3"
              alt="Red Hat corporate logo"
            />
            <h1 class="mb-2">Red Hat Ansible Automation Platform</h1>
            <p class="subhead">
              Access Red Hat subscription-based documentation for the enterprise automation platform.
            </p>
            <p>
              Looking for an older version?
              <a
                href="automation-tower-prior-versions.html"
    ...
    <section class="cards pt-0">
      <div class="container">
        <div class="row">
            ...
            >
              <div class="card border">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Red Hat provides documentation for Automation Platform
                    including installation, Automation Hub, Services Catalog,
                    and Insights.
                  </p>
                </div>
          ...
          <div class="col-md-6 col-lg-4">
            <a
              href="https://docs.ansible.com/automation-controller/latest/html/quickstart/index.html"
            >
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Automation Controller Quickstart</h4>
                  <p class="card-text">
          ...
          <div class="col-md-6 col-lg-4">
            <a
              href="https://docs.ansible.com/automation-controller/latest/html/release-notes/index.html"
            >
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">
                  ...
                  <p class="card-text">
                    View the changes made since the last release of Automation
                    Controller.
                  </p>
                </div>
                <div class="card-footer">
          ...
          <div class="col-md-6 col-lg-4">
            <a
              href="https://docs.ansible.com/automation-controller/latest/html/upgrade-migration-guide/index.html"
            >
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">
                  ...
                  <p class="card-text">
                    Find out how to upgrade Ansible Automation Platform to the
                    latest version.
                  </p>
                </div>
                <div class="card-footer">
          ...
          <div class="col-md-6 col-lg-4">
            <a
              href="https://docs.ansible.com/automation-controller/latest/html/userguide/index.html"
            >
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Automation Controller User Guide</h4>
                  <p class="card-text">
                    Find the complete guide to using Ansible Automation
          ...
          <div class="col-md-6 col-lg-4">
            <a
              href="https://docs.ansible.com/automation-controller/latest/html/administration/index.html"
            >
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">
                  ...
                  <p class="card-text">
                    Learn how to perform administration operations on Ansible
                    Automation Controller with scripts, management jobs, and
                    more.
                  </p>
                </div>
                <div class="card-footer">
          ...
          <div class="col-md-6 col-lg-4">
            <a
              href="https://docs.ansible.com/automation-controller/latest/html/controllerapi/index.html"
            >
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Automation Controller API</h4>
                  <p class="card-text">
          ...
          <div class="col-md-6 col-lg-4">
            <a
              href="https://docs.ansible.com/automation-controller/latest/html/controllercli/index.html"
            >
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">Automation Controller CLI</h4>
                  <p class="card-text">
                    Learn how to use the command-line client for AWX and Ansible
          ...
          <div class="col-md-6 col-lg-4">
            <a href="automation-tower-japanese-translations.html">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">
                    Automation Controller Japanese Translations
                  </h4>
                  <p class="card-text">日本語ドキュメント</p>
                </div>
                <div class="card-footer">
                  <a
                    href="automation-tower-japanese-translations.html"
                    class="btn btn-outline-black"
                    >Learn more</a
                  >
                </div>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="automation-tower-chinese-translations.html">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">
                    Automation Controller Simplified Chinese Translations
                  </h4>
                  <p class="card-text">中文文档</p>
                </div>
                <div class="card-footer">
                  <a
                    href="automation-tower-chinese-translations.html"
                    class="btn btn-outline-black"
                    >Learn more</a
                  >
                </div>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="automation-tower-korean-translations.html">
              <div class="card border">
                <div class="card-body">
                  <h4 class="card-title">
                    Automation Controller Korean Translations
                  </h4>
                  <p class="card-text">한국어 문서</p>
                </div>
                <div class="card-footer">
                  <a
                    href="automation-tower-korean-translations.html"
                    class="btn btn-outline-black"
                    >Learn more</a
                  >
                </div>
