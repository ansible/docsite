...
<head>
    ...
    <title>Ansible Community Documentation Archive</title>
    <meta name="description" content="Archive page for the Ansible community documentation that provides older versions of content.">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col text-center">
                    ...
                    <p class="subhead">Archived versions</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="cards pt-0">
        <div class="container">
             <div class="row">
                    ...
                    <a href="https://docs.ansible.com/archive/ansible/2.6/">
                        <div class="card border">
                            <div class="card-body">
                                <h4 class="card-title">Ansible<br/>version 2.6</h4>
                            </div>
                             <div class="card-footer">
                            <a href="https://docs.ansible.com/archive/ansible/2.6/" class="btn btn-outline-black">Learn more</a>
                            </div>
                        </div>
                    </a>
                </div>
             ...
             <div class="row">
                    <div class="col-md-6 col-lg-4">
                    <a href="https://docs.ansible.com/archive/ansible/2.5/">
                        <div class="card border">
                            <div class="card-body">
                                <h4 class="card-title">Ansible<br/>version 2.5</h4>
                            </div>
                             <div class="card-footer">
                            <a href="https://docs.ansible.com/archive/ansible/2.5/" class="btn btn-outline-black">Learn more</a>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-md-6 col-lg-4">
                    <a href="https://docs.ansible.com/archive/ansible/2.4/">
                        <div class="card border">
                            <div class="card-body">
                                <h4 class="card-title">Ansible<br/>version 2.4</h4>
                            </div>
                             <div class="card-footer">
                            <a href="https://docs.ansible.com/archive/ansible/2.4/" class="btn btn-outline-black">Learn more</a>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-md-6 col-lg-4">
                    <a href="https://docs.ansible.com/archive/ansible/2.3/">
                        <div class="card border">
                            <div class="card-body">
                                <h4 class="card-title">Ansible<br/>version 2.3</h4>
                            </div>
                             <div class="card-footer">
                            <a href="https://docs.ansible.com/archive/ansible/2.3/" class="btn btn-outline-black">Learn more</a>
                            </div>
                        </div>
                    </a>
                </div>
